...
This project is a voxel engine created using the **Three.js** library. The main idea is to render procedurally generated worlds with Minecraft-style camera movement and post-processing effects using **FXAA** (Fast Approximate Anti-Aliasing). The placement of objects, such as light sources and clouds, is dynamically configured, and graphics and performance settings are loaded from an external JSON file.
